...
echo '\033[0;91m ─ Downloading package for this system...\033[0m'
...
echo '\033[0;92msuccess\033[0m'

echo '\033[0;91m ─ Changing directory to /opt...\033[0m'
cd /opt/AdGuardHome
echo '\033[0;92msuccess\033[0m'

echo '\033[0;91m ─ Stopping AdGuard Home...\033[0m'
sudo ./AdGuardHome -s stop
echo '\033[0;92msuccess\033[0m'

echo '\033[0;91m ─ Backing up data to home folder...\033[0m'
mkdir -p ~/agh-backup
sudo cp -r ./AdGuardHome.yaml ./data ~/agh-backup/
echo '\033[0;92msuccess\033[0m'

echo '\033[0;91m ─ Replacing the old AdGuard Home executable file with the new one....\033[0m'
sudo cp -r /tmp/AdGuardHome/AdGuardHome /opt/AdGuardHome/AdGuardHome
echo '\033[0;92msuccess\033[0m'

echo '\033[0;91m ─ Restarting AdGuard Home....\033[0m'
